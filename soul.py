...
FORWARD_CHANNEL_ID = --1002224353885
CHANNEL_ID = --1002224353885
error_channel_id = --1002224353885
...
def handle_message(message):
    ...
    elif message.text == "Canary Download✔️ @raj14754":
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download:https://t.me/c/2224353885/48131 *", parse_mode='Markdown')
    elif message.text == "My Account🏦 @raj14754":
        user_id = message.from_user.id
        user_data = users_collection.find_one({"user_id": user_id})
        if user_data:
